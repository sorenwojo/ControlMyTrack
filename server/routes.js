var appRouter = function(app, turnoutHandler) {
    ...
    app.post("/api/turnouts/:id(\\d+)/manual/setmax", function(req, res) {
    ...
    app.post("/api/turnouts/:id(\\d+)/manual/:position(\\d+)", function(req, res) {
